...
#include <photo_slam_ros/SaveMap.h> // This file is created automatically, see here http://wiki.ros.org/ROS/Tutorials/CreatingMsgAndSrv#Creating_a_srv

// ORB_SLAM3-specific libraries
#include "System.h"
#include "ImuTypes.h"
...
//extern std::shared_ptr<ORB_SLAM3::System> pSLAM;
extern ORB_SLAM3::System::eSensor sensor_type;

//extern std::shared_ptr<GaussianMapper> pGausMapper;
...
bool save_map_srv(photo_slam_ros::SaveMap::Request&, photo_slam_ros::SaveMap::Response&);
bool save_traj_srv(photo_slam_ros::SaveMap::Request&, photo_slam_ros::SaveMap::Response&);
