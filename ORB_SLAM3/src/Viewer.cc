/**
* This file is part of ORB_SLAM3
*
* Copyright (C) 2017-2021 Carlos Campos, Richard Elvira, Juan J. Gómez Rodríguez, José M.M. Montiel and Juan D. Tardós, University of Zaragoza.
* Copyright (C) 2014-2016 Raúl Mur-Artal, José M.M. Montiel and Juan D. Tardós, University of Zaragoza.
*
* ORB_SLAM3 is free software: you can redistribute it and/or modify it under the terms of the GNU General Public
* License as published by the Free Software Foundation, either version 3 of the License, or
* (at your option) any later version.
*
* ORB_SLAM3 is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even
...
//     pangolin::CreateWindowAndBind("ORB_SLAM3: Map Viewer",1024,768);
...
//     Ow.SetIdentity();
//     cv::namedWindow("ORB_SLAM3: Current Frame");
...
//         cv::imshow("ORB_SLAM3: Current Frame",toShow);
//         cv::waitKey(mT);
