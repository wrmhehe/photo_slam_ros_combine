...
bool save_map_srv(photo_slam_ros::SaveMap::Request &req, photo_slam_ros::SaveMap::Response &res)
{
...
bool save_traj_srv(photo_slam_ros::SaveMap::Request &req, photo_slam_ros::SaveMap::Response &res)
{
...
void publish_topics(ros::Time msg_time, Eigen::Vector3f Wbb)
{
    ...
    if (sensor_type == ORB_SLAM3::System::IMU_MONOCULAR || sensor_type == ORB_SLAM3::System::IMU_STEREO || sensor_type == ORB_SLAM3::System::IMU_RGBD)
    {
        // Body pose and translational velocity can be obtained from ORB_SLAM3
